@extends(employeeTheme().'layouts.app') @section('title')
...
<div class="breadcrumb-area">
    ...
    <ol class="breadcrumb">
        <li class="item">
            <a href="{{route('customer.dashboard')}}"><i class="bx bx-home-alt"></i></a>
        </li>
...
@include(adminTheme().'alerts')
    <form action="{{route('customer.editProfile',['update'])}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row mb-4">
            <div class="col-md-6">
                ...
                <div class="inforGrid card basic mb-3">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <th>Designation</th>
                            <td style="padding:0px;">
                                <select disabled class="form-control form-control-sm {{$errors->has('designation_id')?'error':''}}" name="designation_id">
