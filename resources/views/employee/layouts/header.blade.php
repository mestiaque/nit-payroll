...
<nav class="navbar top-navbar navbar-expand">
    <div class="collapse navbar-collapse" id="navbarSupportContent">
        ...
        <ul class="navbar-nav left-nav align-items-center">
            ...
            <li class="nav-item">
                <a href="javascript:void(0)" class="nav-link" data-toggle="tooltip" data-placement="bottom" title="Today">
                ...
                <div class="dropdown-menu">
                    ...
                    <div class="dropdown-body">
                        <ul class="profile-nav p-0 pt-3">
                            @if(Auth::user()->admin)
                            <li class="nav-item">
                                <a href="{{route('admin.dashboard')}}" class="nav-link"> <i class="bx bx-user"></i> <span>Admin Dashboard </span></a>
                            </li>
                            @endif
                            <li class="nav-item">
                                <a href="{{route('customer.myProfile')}}" class="nav-link"> <i class="bx bx-user"></i> <span>My Profile </span></a>
                            </li>
                        </ul>
                    </div>
