...
<title>{{websiteTitle('Engineers List Export')}}</title>
@endsection @push('css')
...
<div class="flex-grow-1" >
    ...
    <div class="card mb-30">
        <div class="card-header d-flex justify-content-between align-items-center">
             <h3>Engineers List Export</h3>
             <div class="dropdown">
                 <a href="{{route('admin.engineersExport')}}" class="btn-custom yellow">
        ...
        <div class="card-body">
                ...
                <form action="{{route('admin.engineersExport')}}">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-0">
                            <div class="input-group">
                                <input type="text" name="search" value="{{request()->search?request()->search:''}}" placeholder="Supplier Name, Mobile" class="form-control {{$errors->has('search')?'error':''}}" />
                    ...
                    <table class="table dataex-html5-export">
                        <thead>
                            <tr>
                                ...
                                <th style="min-width: 150px;">Alt Mobile</th>
                        ...
                        <tbody>
                            @foreach($suppliers as $i=>$supplier)
                                <tr>
                                    ...
                                    <td>{{$supplier->user?$supplier->user->name:''}}</td>
                                    <td>{{$supplier->name}}</td>
                                    <td>{{$supplier->mobile}}</td>
                                    <td>{{$supplier->mobile2}}</td>
                                    <td>{{$supplier->email}}</td>
                                    <td>{{$supplier->short_description}}</td>
                                    <td>{{$supplier->experience}} Years</td>
