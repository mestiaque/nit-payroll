                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @php
                                    $typeLabels = [
                                        ...
                                        'absent_count_for_deduction' => 'Absent Count Rule',
                                        'late_count_for_absent' => 'Late to Absent Rule',
                            ...
                            <td class="text-end">
                                @if($policy->type === 'late_count_for_absent')
                                    {{ (int) $policy->value }} late = 1 absent day
                                @elseif($policy->type === 'absent_count_for_deduction')
                                    {{ (int) $policy->value }} absent = 1 day deduction
                                @else
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="type" class="form-control" required>
                                                    <optgroup label="Deduction Policies">
                                                        ...
                                                        <option value="absent_count_for_deduction" {{ $policy->type == 'absent_count_for_deduction' ? 'selected' : '' }}>Absent Count Rule</option>
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <div class="card bg-light">
                        ...
                        <div class="card-body">
                            @php
                                $latePerMinute = \App\Models\Policy::getValue('late_deduction_per_minute', 0);
                                $lateFixed = \App\Models\Policy::getValue('late_deduction_fixed', 0);
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <p>
                                        ...
                                        @if($latePerMinute > 0)
                                            ৳{{ number_format($latePerMinute, 2) }} per minute
                                        @elseif($lateFixed > 0)
                                            ৳{{ number_format($lateFixed, 2) }} per late
                                        @else
                                            Not set
                                        @endif
                                    </p>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <p><strong>Absent Count Rule:</strong> {{ $absentCountForDeduction }} absents = 1 day deduction</p>
                                    <p><strong>Late Count for Absent:</strong> {{ $lateCountForAbsent }} lates = 1 absent day deduction</p>
                                </div>
                                <div class="col-md-4">
