    ...
    <div class="card mb-30">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered dataex-html5-export">
                    <thead>
                        <tr>
                            <th style="min-width: 60px;width: 60px;padding-right:0;">SL</th>
                            ...
                            <th style="min-width: 120px;">Cus. Status</th>
                            <th style="min-width: 120px;">Next Date</th>
                            <th style="min-width: 120px;">Lead Type</th>
                            <th style="min-width: 200px;">Concern</th>
                            <th style="min-width: 150px;">Interested</th>
