...
<title>{{websiteTitle('Quotation View')}}</title>
@endsection @push('css')
<style type="text/css">
...
<div class="card mb-30">
    <div class="card-header d-flex justify-content-between align-items-center">
         ...
         <div class="dropdown">
             <a href="{{route('admin.quotations')}}" class="btn-custom primary" style="padding:5px 15px;">
             ...
             <a href="{{route('admin.quotationsAction',['edit',$invoice->id])}}" class="btn-custom success" style="padding:5px 15px;">
                ...
                <div class="invoice-inner invoicePage PrintAreaContact">
                    <style>
                            ...
                            <div class="demo-info">
                                ...
                                <h6 style="font-size: 20px;border-top: 1px solid #cccccc;padding-top: 5px;margin:0;font-weight: bold;">QUOTATION</h6>
                            </div>
                        <div class="row">
                            ...
                            <table class="table table-bordered" style="width: 100% !important;">
                              ...
                              <tbody>
                                ...
                                <tr>
                                	...
                                	<th style="text-align: center;font-size:16px;">BDT {{$invoice->total_price}}</th>
                                </tr>
                              </tbody>
                            </table>
