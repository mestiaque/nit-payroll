...
<div class="card mb-30">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div class="dropdown">
            <a href="{{route('admin.salarySheetAction',$createDate->format('Y-m'))}}" class="btn-custom success"><i class="bx bx-list"></i> Back</a>
    ...
    <div class="card-body">
            ...
            <div class="table-responsive">
                <h5 style="text-align:center;">Corporate Employee: {{$corporateSalaries->count()}}</h5>
                <table class="table">
                    <thead>
                        <tr>
                ...
                <h5 style="text-align:center;" >Factory Employee: {{$salaries->count()}}</h5>
                <table  class="table">
                    <thead>
                        <tr>
