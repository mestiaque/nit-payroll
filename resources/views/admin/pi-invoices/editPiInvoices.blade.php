...
<div class="breadcrumb-area">
    ...
    <ol class="breadcrumb">
        ...
        <li class="item"><a href="{{route('admin.piInvoices')}}">Invoices Edit</a></li>
...
<div class="flex-grow-1">
    ...
    <div class="card mb-30">
        <div class="card-header d-flex justify-content-between align-items-center">
             ...
             <div class="dropdown">
                 ...
                 <a href="{{route('admin.piInvoicesAction',['view',$invoice->id])}}" target="_blank" class="btn-custom primary">
        ...
        <div class="card-body">
            ...
            <form action="{{route('admin.piInvoicesAction',['update',$invoice->id])}}">
            @csrf
            <div class="cardItems">
                @include(adminTheme().'pi-invoices.includes.piOrderItems')
            </div>
	 ...
	 <div class="modal-content">
	   <div class="modal-body">
            ...
            <div class="input-group">
                <input type="text" class="form-control {{$errors->has('name')?'error':''}} SearchQuery" data-type="company" data-url="{{route('admin.piInvoicesAction',['search-company',$invoice->id])}}" placeholder="Search name.." required="">
			    <div class="input-group-append">
                    <span class="input-group-text"><i class='bx bx-search'></i></span>
                </div>
			</div>
			<div class="customeSearch searchlist" style="height:200px;overflow:auto;">
		        @include(adminTheme().'pi-invoices.includes.searchCompany')
		    </div>
	   </div>
	 </div>
   </div>
 ...
 <!-- Modal -->
 <div class="modal fade text-left" id="AddMarchantizer" tabindex="-1" role="dialog">
   <div class="modal-dialog" role="document">
	 <div class="modal-content">
	   <div class="modal-body">
	   		<div class="form-group">
			    <label for="name">Search Marchantizer </label>
                <div class="input-group">
                    <input type="text" class="form-control {{$errors->has('name')?'error':''}} SearchQuery" data-type="marchantizer" data-url="{{route('admin.piInvoicesAction',['search-marchantizer',$invoice->id])}}" placeholder="Search name or Short Name.." required="">
				    <div class="input-group-append">
                        <span class="input-group-text"><i class='bx bx-search'></i></span>
                    </div>
				</div>
				<div class="marchantizerSearch searchlist" style="height:200px;overflow:auto;">
			        @include(adminTheme().'pi-invoices.includes.searchMarchantizer')
			    </div>
         	</div>
	   </div>
	 </div>
