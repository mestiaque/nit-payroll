...
Route::group(['prefix'=>'employee', 'as'=>'customer.','middleware'=>['auth','role:customer']], function(){
    ...
    Route::get('/my-attendance', [CustomerController::class, 'myAttendance'])->name('myAttendance');
        Route::get('/conveyance', [CustomerController::class, 'conveyanceIndex'])->name('conveyance.index');
        Route::post('/conveyance', [CustomerController::class, 'conveyanceStore'])->name('conveyance.store');
...
Route::get('/dashboard',[AdminController::class,'dashboard'])->name('dashboard');
    ...
    Route::get('/employee-portal/conveyance', [EmployeePortalController::class, 'conveyanceList'])->name('employee.portal.conveyance');
    Route::get('/employee-portal/conveyance/print', [EmployeePortalController::class, 'conveyancePrint'])->name('employee.portal.conveyance.print');
